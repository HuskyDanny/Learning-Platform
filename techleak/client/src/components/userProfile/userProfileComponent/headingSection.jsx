      ...
      <div className='section profile-heading'>
        <div className='columns is-mobile is-multiline'>
          <div className='column is-2'>
            <span className='header-icon user-profile-image' style={{ paddingLeft: "25%" }}>
              <img alt='' src={faker.image.avatar()}></img>
            </span>
          </div>
          ...
          <div class='column is-2-tablet is-4-mobile has-text-centered'></div>
