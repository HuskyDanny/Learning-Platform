...
class SimplifiedPost extends React.Component {
    ...
    spaceDividor() {
        return <div style={{ margin: "5px", display: "inline-block" }}></div>
    }
    ...
    deleteControl() {
        ...
        if (PostType === "MyPosts") {
            ...
            return (
                <a class="level-item" aria-label="cancel" onClick={(e) => { this.props.handleCancelClick(e, title); this.handleDelete(e, objectID) }}>
                    <span class="icon is-small">
        ...
        return (
            <div class="box" style={{ marginBottom: "0.5rem", padding: "0.8rem" }} >
                <Link to={`/blog/${objectID}`}>
                    <article class="media">
                        <div class="media-left" onClick={(e) => this.handleStopPropagation(e)}>
                            ...
                            <div class="content">
                                ...
                                <nav class="level is-mobile" style={{ float: "right" }}>
                                    <div class="level-left">
                                        <a class="level-item" aria-label="comment" onClick={(e) => this.handleComment(e)} style={{ marginRight: "0.25rem" }}>
                                            <span class="icon is-small">
                                ...
                                <p>
                                    ...
                                    <p style={{ float: "right" }}>
                                        <small>{views} Views</small>{this.spaceDividor()}<small>{answers} Answers</small>
                                    </p>
                                </p>
                            </div>
                        </div>
